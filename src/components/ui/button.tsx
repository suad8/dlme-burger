...
const buttonVariants = cva(
  ...
  'inline-flex items-center justify-center gap-2 rounded-[var(--radius-md)] ' +
    'text-sm font-semibold whitespace-nowrap transition-[background-color,color,box-shadow,opacity] ' +
    'duration-150 outline-none focus-visible:outline-2 focus-visible:outline-offset-2 ' +
