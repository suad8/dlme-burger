...
> **الحالة:** منتج عامل من طرفه إلى طرفه — المراحل ٠ إلى ٤ مكتملة، والمرحلتان
> ٥ و٦ جزئيًا. ٣١ مسارًا، ٦٩ اختبارًا، قاعدة بيانات بـ٥٢ جدولًا.
...
│   │   ├── (auth)/      دخول · تسجيل
│   │   ├── (app)/       المنصة: لوحة · فروع · قوائم فحص · زيارات ·
│   │   │                إجراءات · موظفون · وصفات · مخزون · تقارير ·
│   │   │                إعدادات · لوحة نظام
│   │   ├── api/         مصادقة · تصدير التقارير
│   │   └── design-system/
